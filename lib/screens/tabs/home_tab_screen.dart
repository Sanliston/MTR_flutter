...
//*********************HOME TAB START***************** */
  ...
  static Widget _buildGroupDivider(int index) {
  ...
  static Widget _buildGroupRecents(int index) {
    Widget widget = new Container();
    var recentActivity = groupsList[index]['recent_activity'];
  ...
  static Widget buildMemberInfo(int index) {
