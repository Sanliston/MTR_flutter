  ...
  void initState() {
    ...
    _listOverlayEntry = OverlayEntry(
      ...
      builder: (BuildContext context) {
        return _CustomReorderableListContent(
...
// ReorderableListView.
class _CustomReorderableListContent extends StatefulWidget {
  const _CustomReorderableListContent(
  ...
  @override
  _CustomReorderableListContentState createState() =>
      _CustomReorderableListContentState();
}

class _CustomReorderableListContentState
    extends State<_CustomReorderableListContent>
    with TickerProviderStateMixin<_CustomReorderableListContent> {
  ...
  Widget _wrap(Widget toWrap, int index, BoxConstraints constraints) {
    ...
    final _CustomReorderableListViewChildGlobalKey keyIndexGlobalKey =
        _CustomReorderableListViewChildGlobalKey(toWrap.key, this);
...
@optionalTypeArgs
class _CustomReorderableListViewChildGlobalKey extends GlobalObjectKey {
  const _CustomReorderableListViewChildGlobalKey(this.subKey, this.state)
      : super(subKey);

  final Key subKey;

  final _CustomReorderableListContentState state;

  @override
  bool operator ==(Object other) {
    if (other.runtimeType != runtimeType) return false;
    return other is _CustomReorderableListViewChildGlobalKey &&
        other.subKey == subKey &&
        other.state == state;
  }
