...
class _SliderLayout extends MultiChildLayoutDelegate {
  ...
  static double trackHeight = 5;

  @override
  void performLayout(Size size) {
    //Track
    super.layoutChild(
        track, BoxConstraints.tightFor(width: size.width, height: trackHeight));
    super.positionChild(track, Offset(0.0, size.height / 2 - trackHeight / 2));
...
class _HSVPickerState extends State<HSVPicker> {
  ...
  void hueOnChange(double value) {
    print("Hue on changed called, value: $value");
